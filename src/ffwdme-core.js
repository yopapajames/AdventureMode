 ...
 */
  ...
  watchPosition: function(options, successCallback, errorCallback){
    ...
    this.watchId = gm.info.watchPosition(this.positionUpdate,
      function(err) {},
      {},
      true
    )

    this.speedWatchId = gm.info.watchVehicleData(function(vehicleData) {
        console.log('watchVehicleData ', vehicleData)
        this.gpsSpeed = vehicleData.gps_speed;
      },
      ['gps_speed']
    )
  ...
  clearWatch: function(){
    gm.info.clearPosition(this.watchId)
    gm.info.clearVehicleData(this.speedWatchId)
  },
  ...
  positionUpdate: function(position) {
    position.coords.speed = this.gpsSpeed / 3.6;
    var data = {
